...
import com.android.stephen.mtgpos.fragment.UserFragment.OnListFragmentInteractionListener;
...
public class MyUserRecyclerViewAdapter extends RecyclerView.Adapter<MyUserRecyclerViewAdapter.ViewHolder> {
    ...
    public MyUserRecyclerViewAdapter(LinkedList<StoreModel> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        holder.mContentView.setText(mValues.get(position).getLevel());
